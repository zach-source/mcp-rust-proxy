...
mod tests {
    ...
    use mcp_proxy_core::protocol::{
        JsonRpcMessage, JsonRpcRequest, JsonRpcResponse, JsonRpcV2Message,
    };
    use mcp_proxy_core::transport::{Connection, Transport, TransportType};
    use serde_json::json;
    use std::sync::Arc;
