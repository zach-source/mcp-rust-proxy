...
use crate::state::{LogEntry, ServerInfo}; // TODO: Move to server crate
...
pub struct StdioTransport {
    ...
    server_info: Option<Arc<ServerInfo>>, // TODO: Move to server crate
}
...
impl StdioTransport {
    pub fn new() -> Self {
        Self {
            ...
            working_dir: None,
            server_info: None, // TODO: Move to server crate
        }
    }
